...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Communication Configuration and Stats endpoints MOVED to communication-templates.ts
  // Wizard data route MOVED to wizard.ts

  // Register Wizard routes
  // Wizard routes handled by standard API endpoints
  
  // Add a test email endpoint for debugging
  // Test email route MOVED to email-config.ts
